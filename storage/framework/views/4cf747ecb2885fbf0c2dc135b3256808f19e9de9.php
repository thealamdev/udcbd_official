...
<?php endif; ?>
                <div class="ml-3">
                    <a href="<?php echo e(route('balance-topup')); ?>" class="text-dark">Top Up</a>
                </div>
            </div>
        </li>
    </ul>
...
<!-- /.navbar -->
<?php /**PATH C:\Users\MSI_gaming\Downloads\project_final\project_final\main_site\resources\views/backend/includes/header.blade.php ENDPATH**/ ?>