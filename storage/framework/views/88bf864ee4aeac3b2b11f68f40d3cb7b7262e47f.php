...
<?php endif; ?>
                ...
                <?php if($logged_in_user->hasAllAccess()): ?>
                    <li class="nav-item ml-3">
                        <a href="<?php echo e(route('admin.setting.rechargeBalance', ['id' => $user])); ?>">Rechage Account</a>
                    </li>
                <?php endif; ?>
            </div>
        </div>
...
<?php endif; ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Users\Jafor Computer\Downloads\main_site\resources\views/backend/auth/user/includes/actions.blade.php ENDPATH**/ ?>