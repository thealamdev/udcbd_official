...
<div class="row">
              ...
              <div class="row mt-3 mb-5" style="margin-top: 2rem;">
                  ...
                  <div class="col-6 text-center border border-2 rounded-pill border-dark"
                      ...
                      <h6 style="font-size:25px;" class="m-2 language-switch" data-en="Citizenship certificate" data-bn="নাগরিক সনদ">নাগরিক সনদ</h6>
                  </div>
              ...
              <!-- Row end -->
        <p style="font-size: 18.8px;letter-spacing: 1px;margin-top: 2rem; text-align:justify;" id="text" class="language-switch default-line-spacing" data-en="In this sense, the certificate of Citizenship is being issued, <strong><?php echo e($application->applicant); ?></strong> National Identity Card / Birth Certificate No:  <strong><?php echo e($application->nid_birth); ?></strong> Father/Husband:  <strong><?php echo e($application->father_husband_name); ?>, </strong>Village: <strong><?php echo e($application->mrgram); ?>,</strong> Ward:   <strong><?php echo e($application->mrword); ?></strong>, Post office: <strong><?php echo e($application->mrdak); ?>, </strong>
            </strong>, Union:  <strong><?php echo e($application->union_name); ?></strong>, Upazila: <strong><?php echo e($application->upazilla_name); ?></strong>, District: <strong><?php echo e($application->zilla_name); ?></strong> He belongs to my union: <strong><?php echo e($application->mrword); ?></strong> A permanent resident of Ward no. I know him personally. He is not involved in any anti-social or anti-state activities. He is a permanent citizen and resident of Bangladesh. " data-bn="   এই মর্মে  নাগরিক সনদ প্রদান করা যাইতেছে যে, <strong><?php echo e($application->applicant); ?></strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং: <strong><?php echo e($application->nid_birth); ?></strong> পিতা/স্বামীঃ <strong><?php echo e($application->father_husband_name); ?>, </strong>গ্রামঃ<strong><?php echo e($application->mrgram); ?>,</strong> ওয়ার্ডঃ <strong><?php echo e($application->mrword); ?></strong>, ডাকঘরঃ<strong><?php echo e($application->mrdak); ?>, </strong>
           ...
           নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও জানি। সে সমাজ বা রাষ্ট্র বিরোধী কোন প্রকার কাজের সহিত জড়িত নাই। সে বাংলাদেশের স্থায়ী নাগরিক ও বাসিন্দা।">
           এই মর্মে  নাগরিক সনদ প্রদান করা যাইতেছে যে, <strong><?php echo e($application->applicant); ?></strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং: <strong><?php echo e($application->nid_birth); ?></strong> পিতা/স্বামীঃ <strong><?php echo e($application->father_husband_name); ?>, </strong>গ্রামঃ<strong><?php echo e($application->mrgram); ?>,</strong> ওয়ার্ডঃ <strong><?php echo e($application->mrword); ?></strong>, ডাকঘরঃ<strong><?php echo e($application->mrdak); ?>, </strong>
...
</div><?php /**PATH C:\laragon\www\udcbd\resources\views/backend/content/applications/sanad-certificate/c_nagorik.blade.php ENDPATH**/ ?>