    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('frontend.user.union.info.store')); ?>"
                        enctype="multipart/form-data" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php if($union): ?>
                            <input type="hidden" name="union_id" class="form-control" value="<?php echo e($union->id); ?>">
                        <?php endif; ?>
                        <div class="row">
                            <div class="col-6">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if($union): ?>
                                    <img src="<?php echo e(asset('/setting/unioninfo/' . $union->logo) ?? 'N/A'); ?>"
                                        style="height: 100px">
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </td>
                            <td class="text-center"><?php echo e($div->bn_name ?? 'N/A'); ?></td>
                            <td class="text-center"><?php echo e($district->bn_name ?? 'N/A'); ?></td>
                            <td class="text-center"><?php echo e($upzilla->bn_name ?? 'N/A'); ?></td>
                            <td class="text-center"><?php echo e($union->union_no ?? 'N/A'); ?></td>
                            <td class="text-center"><?php echo e($uni->bn_name ?? 'N/A'); ?></td>
                            <td class="text-center"><?php echo e($union->chairman ?? 'N/A'); ?></td>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#present_district").on('change', function() {
                ...
                if (zilla_id) {
                    $.ajax({
                        url: "<?php echo e(url('/upzilla-get/ajax')); ?>/" + zilla_id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
            ...
            $("#present_thana").on('change', function() {
                ...
                if (upzilla_id) {
                    $.ajax({
                        url: "<?php echo e(url('/union-get/ajax')); ?>/" + upzilla_id,
                        type: "GET",
                        dataType: "json",
                        success: function(data) {
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\udcbd\resources\views/backend/content/union_info/index.blade.php ENDPATH**/ ?>