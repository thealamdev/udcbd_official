...
<div class="row">
              ...
              <!-- Data start -->
              <div class="row mt-3 mb-5" style="margin-top: 0rem;">
                  ...
                  <div class="col-6 text-center border border-2 rounded-pill border-dark"
                      style="background-color: #B4D5FF;margin-top:0em;">
                      <h6 style="font-size:25px;" class="m-2 language-switch" data-en="Warishian Charter" data-bn="ওয়ারিশিয়ান সনদপত্র">ওয়ারিশিয়ান   সনদপত্র</h6>
                  </div>
              ...
              <!-- Row end -->
        <p style="font-size: 18.8px;letter-spacing: 1px;margin-top: -2rem; text-align:justify;" id="text" class="language-switch default-line-spacing" data-en="In this sense, the certificate of Warishian  is being issued, <strong><?php echo e($application->applicant); ?></strong> National Identity Card / Birth Certificate No:  <strong><?php echo e($application->nid_birth); ?></strong> Father/Husband:  <strong><?php echo e($application->father_husband_name); ?>, </strong>Village: <strong><?php echo e($application->mrgram); ?>,</strong> Ward:   <strong><?php echo e($application->mrword); ?></strong>, Post office: <strong><?php echo e($application->mrdak); ?>, </strong>
            </strong>, Union:  <strong><?php echo e($application->union_name); ?></strong>, Upazila: <strong><?php echo e($application->upazilla_name); ?></strong>, District: <strong><?php echo e($application->zilla_name); ?></strong> He belongs to my union: <strong><?php echo e($application->mrword); ?></strong> A permanent resident of Ward no. According to the informant, he died as underwritten Warishian. " data-bn="   এই মর্মে ওয়ারিশিয়া   সনদপত্র প্রদান করা যাইতেছে যে, <strong><?php echo e($application->applicant); ?></strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং: <strong><?php echo e($application->nid_birth); ?></strong> পিতা/স্বামীঃ <strong><?php echo e($application->father_husband_name); ?>, </strong>গ্রামঃ<strong><?php echo e($application->mrgram); ?>,</strong> ওয়ার্ডঃ <strong><?php echo e($application->mrword); ?></strong>, ডাকঘরঃ<strong><?php echo e($application->mrdak); ?>, </strong>
           ...
           নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা ছিলেন।  তথ্য দাতার তথ্য মতে তিনি নিম্ন লিখিত ওয়ারিশিয়ান হিসাবে রেখে মৃত্যু বরন করিয়েছেন।। ।।">
           এই মর্মে ওয়ারিশিয়ান   সনদপত্র প্রদান করা যাইতেছে যে, <strong><?php echo e($application->applicant); ?></strong> জাতীয় পরিচয়পত্র / মৃত্যু সনদ নং: <strong><?php echo e($application->nid_birth); ?></strong> পিতা/স্বামীঃ <strong><?php echo e($application->father_husband_name); ?>, </strong>গ্রামঃ<strong><?php echo e($application->mrgram); ?>,</strong> ওয়ার্ডঃ <strong><?php echo e($application->mrword); ?></strong>, ডাকঘরঃ<strong><?php echo e($application->mrdak); ?>, </strong>
         ...
         <!-- row Start -->
              ...
              <?php
                  ...
                  $enid = explode(',', $oarish->rnid);
                    $ebirth = explode(',', $oarish->rbirth);
                  $ecom = explode(',', $oarish->rcom);

              ?>
              <table class="table table-bordered table-responsive font-12">
                  <thead>
                      <tr>
                         <th class="language-switch" data-en="Sequential:" data-bn="ক্রমিকঃ" style="font-size: 18.8px; width: 5%; text-align: center;">ক্রমিক</th>
                          <th class="language-switch" data-en="Name" data-bn="নাম" style="font-size: 18.8px; width: 36%; text-align: center;">নাম</th>
                          <th class="language-switch" data-en="Relationship" data-bn="সম্পর্ক" style="font-size: 18.8px; width: 13%; text-align: center;">সম্পর্ক</th>
                        
                          <th class="language-switch" data-en="Nid/Birth" data-bn="ভোটার/জম্ম নিবন্ধন" style="width: 30%; font-size: 18.8px;  text-align: center;">ভোটার/জম্ম নিবন্ধন</th>
                            <th class="language-switch" data-en="DOB" data-bn="জন্মতারিখ" style="width: 18%;font-size: 18.8px; text-align: center;">জন্মতারিখ</th>
                          <th class="language-switch" data-en="comment" data-bn="মন্তব্য" style="width: 10%;font-size: 18.8px;  text-align: center;">মন্তব্য</th>
                      </tr>
                  </thead>
                  <tbody>
                      <?php $__currentLoopData = $sl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                              <td class="text-center" style="font-size: 18.8px;" ><?php echo e($sl[$key]); ?></td>
                              <td class="text-center"  style="font-size: 18.8px;" ><?php echo e($name[$key]); ?></td>
                              <td class="text-center" style="font-size: 18.8px;" ><?php echo e($rel[$key]); ?></td>
                        
                              <td class="text-center" style="font-size: 18.8px;" ><?php echo e($enid[$key]); ?></td>
                                    <td class="text-center" style="font-size: 18.8px;" ><?php echo e($ebirth[$key]); ?></td>
                              <td class="text-center" style="font-size: 18.8px;" ><?php echo e($ecom[$key]); ?></td>
        ...
        <p style="font-size: 18.8px;letter-spacing: 1px;" id="text" class="language-switch default-line-spacing"  class="language-switch" data-en="I pray for the peace of his departed soul and all the prosperity and well being of the living" data-bn="
আমি তার বিদেহি আত্মার শান্তি ও জীবিতদের সার্বিক উন্নতি ও মঙ্গল কামনা করছি।
">
আমি তার বিদেহি আত্মার শান্তি ও জীবিতদের সার্বিক উন্নতি ও মঙ্গল কামনা করছি।
</p>
              ...
              <!-- Row start -->
              <div class="row mb-4 print-mb-2" style="margin-top: 3em;">
                  <!-- seal area -->
...
</div><?php /**PATH C:\Users\Jafor Computer\Downloads\main_site\resources\views/backend/content/applications/sanad-certificate/c_oarish.blade.php ENDPATH**/ ?>