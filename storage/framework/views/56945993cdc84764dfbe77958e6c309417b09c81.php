        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <div class="card" style="box-shadow: 13px 13px 20px #cbced1, -13px -13px 20px #fff;">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('frontend.auth.agent.registered')); ?>" method="POST" id="registerForm">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\udcbd\resources\views/agents/auth/register.blade.php ENDPATH**/ ?>