...
<?php endif; ?>
            ...
            <?php if($logged_in_user->hasAllAccess()): ?>
                <li class="nav-item ml-3">
                    <a href="<?php echo e(route('admin.setting.certificatePrice')); ?>">Certificate Price</a>
                </li>

                <li class="nav-item ml-3">
                    <a href="<?php echo e(route('admin.agent.withdrawRequest')); ?>">WithDraw Request</a>
                </li>
                <li class="nav-item ml-3">
                    <a href="<?php echo e(route('admin.agentSetting.index')); ?>">Agent Settings</a>
                </li>
            <?php endif; ?>
...
<?php /**PATH C:\Users\Jafor Computer\Downloads\main_site\resources\views/backend/includes/sidebar.blade.php ENDPATH**/ ?>