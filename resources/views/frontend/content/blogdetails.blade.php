        ...
        <section class="xs-banner-inner-section2 parallax-window"
            ...
            <div class="container">
                <div class="color-white xs-inner-banner-content">
                    <h2 style="color: black;">{{ $blog->banner_text }}</h2>
                </div>
            </div>
        </section>
        <section class="mt-5" style="margin-bottom: 20%">
            <div class="container" style="max-width: 90%;">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-2">
                                ...
                                {{-- <p>নতুন ব্যবহারকারী তৈরি করুন</p> --}}
                            </div>
                            <div class="col-2"> <button type="button" class="btn btn-primary" data-toggle="modal"
                    ...
                    @endif
                    <div class="modal fade bd-example-modal-lg" id="new" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-content">
                                <div class="card-body">
                                    <form action="{{ route('frontend.user-info.store') }}" method="POST"
                                        ...
                                        @csrf
                                        <input type="hidden" name="sanad_id" value="{{ $id }}">
                                            ...
                                            <div class="col-6">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="father_or_husband_en">পিতার/স্বামীর নাম (ইংরেজিতে)
                                                                *</label>
                                                            <input type="text" class="form-control"
                                                                name="father_or_husband_en" value="" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="father_or_husband_bn">পিতার / স্বামীর নাম (বাংলায়)
                                                                *</label>
                                                            <input type="text" class="form-control"
                                                                name="father_or_husband_bn" value="" required>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="voter_birth_id">জাতীয় পরিচয়পত্র নং অথবা জন্ম
                                                                নিবন্ধন
                                                                নং
                                                                *</label>
                                                            <div class="row">
                                                                <div class="col-5">
                                                                    <select name="certificate_type" class="form-control"
                                                                        ...
                                                                        <option value="voter_id">জাতীয় পরিচয়পত্র নং
                                                                        </option>
                                                                ...
                                                                <div class="col-7">
                                                                    <input type="text" class="form-control"
                                                                        name="voter_birth_id" value="" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control"
                                                                name="voter_birth_photo" value="" required>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="present_village_en">গ্রাম / বাড়ী (ইংরেজিতে)
                                                                        *</label>
                                                                    <input type="text" class="form-control"
                                                                        name="present_village_en" id="present_village_en"
                                                                        value="" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="present_village_bn">গ্রাম /বাড়ী (বাংলায়)
                                                                        *</label>
                                                                    <input type="text" class="form-control"
                                                                        name="present_village_bn" id="present_village_bn"
                                                                        value="" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="present_road_en">রাস্তা / ব্লক / শাখা
                                                                        (ইংরেজিতে)</label>
                                                                    <input type="text" class="form-control"
                                                                        name="present_road_en" id="present_road_en"
                                                                        value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="present_road_bn">রাস্তা /ব্লক / শাখা
                                                                        (বাংলায়)</label>
                                                                    <input type="text" class="form-control"
                                                                        name="present_road_bn" id="present_road_bn"
                                                                        value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select id="present_address_type"
                                                                        name="present_address_type" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                                        <option value="city_corporation">সিটি কর্পোরেশন
                                                                        </option>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        name="present_post_office" value=""
                                                                        required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="present_owner_type"
                                                                        id="present_owner_type" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="permanent_village_en">গ্রাম / বাড়ী
                                                                        (ইংরেজিতে)
                                                                        *</label>
                                                                    <input type="text" class="form-control"
                                                                        id="permanent_village_en"
                                                                        name="permanent_village_en" value=""
                                                                        required>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_village_bn">গ্রাম /বাড়ী (বাংলায়)
                                                                        *</label>
                                                                    <input type="text" class="form-control"
                                                                        id="permanent_village_bn"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_holding_no_en">হোল্ডিং নং
                                                                        (ইংরেজিতে)</label>
                                                                    <input type="text" class="form-control"
                                                                        id="permanent_holding_no_en"
                                                                        name="permanent_holding_no_en" value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_holding_no_bn">হোল্ডিং নং
                                                                        (বাংলায়)</label>
                                                                    <input type="text" class="form-control"
                                                                        id="permanent_holding_no_bn"
                                                                        name="permanent_holding_no_bn" value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_road_en">রাস্তা / ব্লক / শাখা
                                                                        (ইংরেজিতে)</label>
                                                                    <input type="text" class="form-control"
                                                                        id="permanent_road_en" name="permanent_road_en"
                                                                        value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_road_bn">রাস্তা /ব্লক / শাখা
                                                                        (বাংলায়)</label>
                                                                    <input type="text" class="form-control"
                                                                        id="permanent_road_bn" name="permanent_road_bn"
                                                                        value="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_address_type">ঠিকানার ধরণ
                                                                        *</label>
                                                                    <select id="permanent_address_type"
                                                                        name="permanent_address_type" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                                        <option value="city_corporation">সিটি কর্পোরেশন
                                                                        </option>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="permanent_division"
                                                                        id="permanent_division" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                                        @foreach ($divisions as $division)
                                                                            <option value="{{ $division->id }}">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="permanent_district"
                                                                        id="permanent_district" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        name="permanent_post_office" value=""
                                                                        required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="permanent_owner_type">মালিকানার ধরণ
                                                                        *</label>
                                                                    <select name="permanent_owner_type"
                                                                        id="permanent_owner_type" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                                        <option value="owner">বাড়ির মালিক</option>
                                                                        <option value="rental">ভাড়াটিয়া</option>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="permanent_ward_no"
                                                                        id="permanent_ward_no" class="form-control"
                                                                        required>
                                                                        <option value="">নির্বাচন করুন</option>
                                                                        <option value="1">১নং</option>
                                                                        <option value="2">২নং</option>
                    ...
                    <div class="modal fade" id="registered" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('frontend.registered.user.apply') }}" method="get"
                                    enctype="multipart/form-data">
                                    @csrf
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $.each(data, function(key, value) {
                                    ...
                                    liItem.classList.add('option');
                                    liItem.innerHTML = value.bn_name;
                                    $("#permanent_thana").append('<option value="' + value
                                        .id + '">' + value.bn_name + '</option>');
                                });
                            },
                        });
