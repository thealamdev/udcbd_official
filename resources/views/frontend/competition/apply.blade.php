...
@section('content')
    <main class="xs-main">
        <section class="xs-banner-inner-section2 parallax-window"
            style="background-image: url({{ asset('/setting/competition/' . $blog->banner_image) }}); ">
        ...
        <section class="mt-5 mb-5">
            <div class="container" style="max-width: 90%;">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('frontend.training.application.store') }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="present_holding_no_en" name="present_holding_no_en"
                                                            value="">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="present_holding_no_bn" name="present_holding_no_bn"
                                                            value="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="present_post_office" name="present_post_office"
                                                            value="" required>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="permanent_village_en" name="permanent_village_en"
                                                            value="" required>
                                                    </div>
                                                </div>
                                                <div class="col-6">
