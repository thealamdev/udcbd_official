            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 footer-widget xs-pr-20">
                    <a href="/" class="xs-footer-logo footmobile">
                        <img src="{{ asset(get_setting('frontend_logo_footer')) }}" style="max-width: 100%; height: auto;"
                            alt="">
                    </a>
                    <h3 style="color: white;">{{ get_setting('footer_description') }}</h3>


                    <img src="{{ asset(get_setting('affiliate_logo')) }}" style="max-width: 100%; height: auto;"
                        alt="">
                ...
                <div class="col-lg-4 col-md-6 footer-widget">
                    ...
                    <ul class="xs-info-list">
                        ...
                        <li><i class="fa fa-envelope-o bg-blue"></i><a href=""><span class="__cf_email__"
                                    data-cfemail="dea7b1abacb0bfb3bb9ebab1b3bfb7b0f0bdb1b3">{{ get_setting('office_email') }}</span></a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-6 footer-widget">
