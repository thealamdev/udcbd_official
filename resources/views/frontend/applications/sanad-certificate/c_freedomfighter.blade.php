...
<div class="row">
              ...
              <div class="row mt-3 mb-5" style="margin-top: 2rem;">
                  ...
                  <div class="col-6 text-center border border-2 rounded-pill border-dark"
                      ...
                      <h6 style="font-size:25px;" class="m-2 language-switch" data-en="Freedom fighter certification" data-bn="মুক্তিযোদ্ধা প্রত্যয়ন">মুক্তিযোদ্ধা প্রত্যয়ন</h6>
                  </div>
              ...
              <!-- Row end -->
        <p style="font-size: 18.8px;letter-spacing: 1px;margin-top: 2rem; text-align:justify;" id="text" class="language-switch default-line-spacing" data-en="In this sense, the certificate of financial insolvency is being issued, <strong>{{ $application->applicant }}</strong> National Identity Card / Birth Certificate No:  <strong>{{ $application->nid_birth }}</strong> Father/Husband:  <strong>{{ $application->father_husband_name }}, </strong>Village: <strong>{{ $application->mrgram }},</strong> Ward:   <strong>{{ $application->mrword }}</strong>, Post office: <strong>{{ $application->mrdak }}, </strong>
            </strong>, Union:  <strong>{{ $application->union_name }}</strong>, Upazila: <strong>{{ $application->upazilla_name }}</strong>, District: <strong>{{ $application->zilla_name }}</strong> He belongs to my union: <strong>{{ $application->mrword }}</strong> A permanent resident of Ward no. I know him personally. He is not involved in any anti-social or anti-state activities . According to my knowledge he is __________a __________|.His Gazette No. <strong>{{ $application->geg }}</strong> Lalmuktibarta No. <strong>{{ $application->lal }}</strong> Commemorates his contribution in the Great War of Liberation. used to According to the announcement of the Hon'ble Prime Minister, he is eligible to get all the state benefits of freedom fighter quota as a freedom fighter. " data-bn="   এই মর্মে মুক্তিযোদ্ধা প্রত্যয়ন প্রদান করা যাইতেছে যে, <strong>{{ $application->applicant }}</strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং: <strong>{{ $application->nid_birth }}</strong> পিতা/স্বামীঃ <strong>{{ $application->father_husband_name }}, </strong>গ্রামঃ<strong>{{ $application->mrgram }},</strong> ওয়ার্ডঃ <strong>{{ $application->mrword }}</strong>, ডাকঘরঃ<strong>{{ $application->mrdak }}, </strong>
           ...
           নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও জানি। সে সমাজ বা রাষ্ট্র বিরোধী কোন প্রকার কাজের সহিত জড়িত নাই।। আমার জানামতে তার _<strong>{{ $application->rr1 }}</strong>একজন মুক্তিযোদ্ধা |।তারএর গেজেট নং  <strong>{{ $application->geg }}</strong>  লালমুক্তিবার্তা নং  <strong>{{ $application->lal }}</strong> মহান মুক্তিযুদ্ধে তার অবদানের কথা স্মরণ করত। মাননীয় প্রধানমন্ত্রীর ঘোষনা অনুযায়ী সে <strong>{{ $application->rr2 }}</strong> মুক্তিযোদ্ধা কোটার সকল প্রকার রাষ্ট্রীয় সুযোগ সুবিধা পাওয়ার যোগ্য।|।">
           এই মর্মে মুক্তিযোদ্ধা প্রত্যয়ন প্রদান করা যাইতেছে যে, <strong>{{ $application->applicant }}</strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং: <strong>{{ $application->nid_birth }}</strong> পিতা/স্বামীঃ <strong>{{ $application->father_husband_name }}, </strong>গ্রামঃ<strong>{{ $application->mrgram }},</strong> ওয়ার্ডঃ <strong>{{ $application->mrword }}</strong>, ডাকঘরঃ<strong>{{ $application->mrdak }}, </strong>
           ...
           নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও জানি। সে সমাজ বা রাষ্ট্র বিরোধী কোন প্রকার কাজের সহিত জড়িত নাই। আমার জানামতে তার __________একজন __________|।তারএর গেজেট নং  <strong>{{ $application->geg }}</strong>  লালমুক্তিবার্তা নং  <strong>{{ $application->lal }}</strong> মহান মুক্তিযুদ্ধে তার অবদানের কথা স্মরণ করত। মাননীয় প্রধানমন্ত্রীর ঘোষনা অনুযায়ী সে মুক্তিযোদ্ধার____________হিসেবে মুক্তিযোদ্ধা কোটার সকল প্রকার রাষ্ট্রীয় সুযোগ সুবিধা পাওয়ার যোগ্য।
