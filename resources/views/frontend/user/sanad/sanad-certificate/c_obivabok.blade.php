              ...
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="row mt-3 mb-5">
                      ...
                      <div class="col-6 text-center border border-2 rounded-pill border-dark" style="background-color: #B4D5FF;">
                          <h6 class="m-2">অভিভাবকের অনুমতি পত্র</h6>
                      </div>
                  ...
                  <div class="d-block mt-2 mb-4 print-mb-2 lh-lg print-lh">
                      <span class="me-2">সে আমার পুত্র/কন্যা। সে সাহসিকতা ও মনোবলে বলিয়ান হেতু বাংলাদেশ</span>
                      <span class="me-2">{{ $application->battalion_name }}</span>
                      <span class="me-2">বাহিনীতে যোগ দিয়া দেশ রক্ষার কাজে আত্ম নিয়োগ করার জন্য আমি সুস্থ
                          মস্তিস্কে এবং সজ্ঞানে অনুমতি প্রদান করিলাম।</span>
