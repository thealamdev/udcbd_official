          ...
          <div class="card-body print-p-0">
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="d-block mt-2">
                      ...
                      <span class="me-2">নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা ও জম্ম সুত্রে বাংলাদেশের নাগরিক। আমার
                          জানামতে অত্র এলাকায় তিনি একমাত্র ব্যক্তি</span>
                      <span> {{ $application->name }}</span>
                      <span class="ms-1">নামে পরিচিত। ইহা সত্য।</span>
