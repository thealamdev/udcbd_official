          ...
          <div class="card-body print-p-0">
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="d-flex justify-content-between mt-3 mb-5">
                      <div class="my-auto">স্মারক নং - {{ $application->form_serial }}</div>

                      <div class="text-center border border-2 rounded-pill border-dark" style="background-color: #B4D5FF;">
                          <h6 class="m-2">বাৎসরিক আয়ের সনদপত্র</h6>
                      </div>

                      <div class="align-items-md-end my-auto">তারিখঃ {{ $application->form_date }}</div>
                  </div>
                  ...
                  <div class="d-block mt-2 mb-4 print-mb-2 lh-lg print-lh">
                      ...
                      <span>|</span>
                      <span class="me-2">তার অভিভাবকের বার্ষিক উপার্জন</span>
                      <span class="me-2">{{ $application->gurdian_yearly_earn }}</span>
                      <span class="me-2">টাকা। কথায়ঃ</span>
                      <span class="me-2">{{ $application->gurdian_yearly_earn_description }}</span>
              ...
              <div class="print-shadow-0 print-m-0 application-form d-print-none text-center mt-3">
                  {{-- <form action="{{ route('frontend.user.application.certificate.info') }}" method="POST">
                  @csrf
                  <input type="hidden" name="printed_on" value="{{}}"> --}}
      ...
      (function($) {
          $(document).ready(function() {
              $('#print-certificate').on('click', function() {
                  $('.application-form').removeClass('d-print-block').addClass('d-print-none');
                  $('.certificate-form').removeClass('d-print-none').addClass('d-print-block');
                  print();
              });
          });
      })(jQuery);
