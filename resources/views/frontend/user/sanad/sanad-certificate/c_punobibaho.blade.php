              ...
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="row mt-3 mb-5">
                      ...
                      <div class="col-6 text-center border border-2 rounded-pill border-dark" style="background-color: #B4D5FF;">
                          <h6 class="m-2">দ্বিতীয় বিবাহ না হওয়ার সনদ</h6>
                      </div>
                  ...
                  <div class="d-flex">
                      <p class="me-2">জাতীয় পরিচয়পত্র / জন্ম সনদ</p><span class="me-2">:</span>
                      <div class="flex-fill form-group">
                  ...
                  <div class="row mb-4 print-mb-2">
                      <div class="col-12">
                          <div class="d-flex">
                              <span class="me-2 w-120">পিতা/স্বামী</span><span class="me-2">:</span>
                              <div class="flex-fill form-group">
                                  <input type="text" name="father_husband_name" value="{{ $application->father_husband_name }}" class="w-100 border-0 border-bottom-dotted border-dark bg-transparent" data-bv-notempty-message="দয়া করে পিতা/স্বামী নাম  লিখুন" readonly>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="row mb-4 print-mb-2">
                      <div class="col-12">
                          <div class="d-flex">
                              ...
                              <div class="flex-fill form-group">
                                  <input type="text" name="upazilla_name" value="{{ $application->upazilla_name }}" class="w-100 border-0 border-bottom-dotted border-dark bg-transparent" data-bv-notempty-message="দয়া করে উপজেলার নাম  লিখুন" readonly>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="col-12">
                          <div class="d-flex">
                              ...
                              <div class="flex-fill form-group">
                                  <input type="text" name="zilla_name" value="{{ $application->zilla_name }}" class="w-100 border-0 border-bottom-dotted border-dark bg-transparent" data-bv-notempty-message="দয়া করে জেলার নাম  লিখুন" readonly>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="d-block mt-2 mb-4 print-mb-2 lh-lg print-lh">
                      <span class="me-2">আমি তাকে চিনি ও জানি। সে অত্র ইউনিয়ন পরিষদ এর</span>
                      <span class="me-2">{{ $application->ward_no }}</span>
                      <span class="me-2">নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা ও জম্ম সুত্রে বাংলাদেশের নাগরিক। আমার জানা
                          মতে তার স্বামী /স্ত্রী মারা যাওয়ার পর তিনি দ্বিতীয় বিবাহ করেন নাই। ইহা সত্য।</span>
                      <p class="mt-5">আমি তার সর্বাঙ্গিন মঙ্গল ও উন্নতি কামনা করি।</p>
                  </div>
