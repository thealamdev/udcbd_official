              ...
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="row mt-3 mb-5">
                      ...
                      <div class="col-6 text-center border border-2 rounded-pill border-dark" style="background-color: #B4D5FF;">
                          <h6 class="m-2">মুক্তিযোদ্ধা প্রত্যয়নপত্র</h6>
                      </div>
                  ...
                  <div class="d-block mt-2 mb-4 print-mb-2 lh-lg print-lh">
                      ...
                      <span class="me-2">নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা ও জম্ম সুত্রে বাংলাদেশের নাগরিক।
                          আমার জানামতে তার</span>
                      <span class="me-2">{{ $application->relation }}</span>
                      <span class="me-2">একজন বীর মুক্তিযোদ্ধা। তার</span>
                      <span class="me-2">{{ $application->relation2 }}</span>
                      <span class="me-2">এর গেজেট নং-</span>
                      <span class="me-2">{{ $application->gajet_no }}</span>
                      <span class="me-2">| মহান মুক্তিযুদ্ধে তার</span>
                      <span class="me-2">{{ $application->obodan }}</span>
                      <span class="me-1">এর অবদানের কথা স্মরণ করত:- মাননীয় প্রধানমন্ত্রীর ঘোষনা অনুযায়ী সে
                          মুক্তিযোদ্ধার পুত্র-কন্যা/নাতি-নাতনি হিসেবে মুক্তিযোদ্ধা কোটার সকল প্রকার রাষ্ট্রীয়
                          সুযোগ সুবিধা পাওয়ার যোগ্য।</span>
