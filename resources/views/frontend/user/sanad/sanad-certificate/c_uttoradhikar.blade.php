              ...
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="row mt-3 mb-5">
                      ...
                      <div class="col-6 text-center border border-2 rounded-pill border-dark" style="background-color: #B4D5FF;">
                          <h6 class="m-2">উত্তরাধিকার সনদপত্র</h6>
                      </div>
                  ...
                  <div class="d-flex">
                      ...
                      <div class="flex-fill">
                          <input class="border-0 border-bottom-dotted text-center w-100 bg-transparent" type="text" value="{{ $uttoradhikar->dead_person_name }}" data-bv-notempty-message="দয়া করে নাম লিখুন" readonly>
                      </div>
                  </div>
                  ...
                  <div class="d-flex">
                      <div class="d-flex flex-fill">
                          ...
                          <div class="flex-fill form-group">
                              <input class="border-0 border-bottom-dotted text-center w-100 bg-transparent" type="text" value="{{ $uttoradhikar->dead_person_father_husband_name }}" data-bv-notempty-message="দয়া করে পিতা/স্বামীর নাম লিখুন">
                          </div>
                      </div>
                      ...
                      <div class="d-flex flex-fill">
                          ...
                          <div class="flex-fill form-group">
                              <input class="border-0 border-bottom-dotted text-center w-100 bg-transparent" type="text" value="{{ $uttoradhikar->dead_person_village }}" data-bv-notempty-message="দয়া করে  নাম লিখুন" readonly>
                          </div>
                      </div>
                  </div>
                  <div class="d-flex">
                      <div class="d-flex flex-fill">
                          ...
                          <div class="flex-fill form-group">
                              <input class="border-0 border-bottom-dotted text-center w-100 bg-transparent" type="text" value="{{ $uttoradhikar->dead_person_union }}" data-bv-notempty-message="দয়া করে ডাকঘরের নাম লিখুন" readonly>
                          </div>
                      </div>
                      <div class="d-flex flex-fill">
                          <p class="ms-1 me-1">উপজেলাঃ</p>
                          <div class="flex-fill form-group">
                              <input class="border-0 border-bottom-dotted text-center w-100 bg-transparent" type="text" value="{{ $uttoradhikar->dead_person_upazilla }}" data-bv-notempty-message="দয়া করে উপজেলার নাম লিখুন" readonly>
                          </div>
                      </div>
                      <div class="d-flex flex-fill">
                          <p class="ms-1 me-1">জেলাঃ</p>
                          <div class="flex-fill form-group">
                              <input class="border-0 border-bottom-dotted text-center w-75 bg-transparent" type="text" value="{{ $uttoradhikar->dead_person_zilla }}" data-bv-notempty-message="দয়া করে জেলার নাম লিখুন" readonly>।
                          </div>
                      </div>
                  </div>
                  <!-- row end -->
                  ...
                  <div class="col-12 mt-2">
                      <p class="">তিনি আমার পরিচিত ছিলেন। তিনি মৃত্যুকালে নিম্ন বর্ণিত উত্তরাধিকারগণ রাখিয়া
                          মৃত্যুবরণ
                          করিয়াছেন।</p>
                  </div>
                  <!-- row end -->
                  ...
                  $birth = explode(',', $uttoradhikar->birth);
                  ...
                  <table class="table table-bordered table-responsive font-12">
                      <thead>
                          <tr>
                              ...
                              <th style="text-align: center;">জন্মতারিখ</th>
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td class="text-center">{{ $birth[$key] }}</td>
