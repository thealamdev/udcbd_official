              ...
              <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                  ...
                  <div class="row mt-3 mb-5">
                      ...
                      <div class="col-6 text-center border border-2 rounded-pill border-dark" style="background-color: #B4D5FF;">
                          <h6 class="m-2">অবিবাহিত সনদপত্র</h6>
                      </div>
                  ...
                  <div class="d-block mt-2">
                      ...
                      <span class="me-1">নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা ও জম্ম সুত্রে বাংলাদেশের নাগরিক। আমার
                          জানামতে সে
                          একজন অবিবাহিত নাগরিক। সে উন্নত চরিত্রের অধিকারী। আমি যতদূর জানি সে কোন সমাজ ও রাষ্ট্র
                          দ্রোহী
                          কাজের
                          সাথে সম্পৃক্ত নয়।</span>
                      <p class="mt-4">আমি তার সর্বাঙ্গিন মঙ্গল ও উন্নতি কামনা করি।</p>
                  </div>
