                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ মুক্তিযোদ্ধা প্রত্যয়ন প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            ...
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="appERlicant" value="" data-bv-notempty-message="দয়া করে নাম লিখুন" required="" data-bv-field="applicant"><i class="form-control-feedback bv-no-label" data-bv-icon-for="applicant" style="display: none;"></i>
                                    ...
                                    <div class="d-block">
                                     ...
                                     <div class="d-flex">
                                        ...
                                        <div class="d-flex">
                                        <p class="me-2">নাল মুক্তিকর্তা নং:</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-100 nid-birth" type="text" name="lal" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                         <div class="d-flex">
                                        <p class="me-2">গেজেট নং:</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-100 nid-birth" type="text" name="geg" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                        ...
                                        <div class="d-flex">
                                        <div class=" small d-flex flex-fill">
                                            <p>আমার জানামতে তার :</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="rr1" value="" data-bv-notempty-message="দয়া করে নাম লিখুন" required="" data-bv-field="applicant"><i class="form-control-feedback bv-no-label" data-bv-icon-for="applicant" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="applicant" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে নাম লিখুন</small>
                                            </div>
                                        </div>
                                        ...
                                        <p class="me-2">একজন  মুক্তিযোদ্ধা মাননীয় প্রধানমন্ত্রীর ঘোষনা অনুযায়ী সে মুক্তিযোদ্ধার:</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-100 nid-birth" type="text" name="rr2" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-fill">
                                        ...
                                        <p class="me-2">হিসেবে মুক্তিযোদ্ধা কোটার সকল প্রকার রাষ্ট্রীয় সুযোগ সুবিধা পাওয়ার যোগ্য।:</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-0 nid-birth" type="hidden" name="geffg" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি মুক্তিযোদ্ধা প্রত্যয়ন প্রদানের
