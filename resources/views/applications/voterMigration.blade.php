                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center mb-4">
                                            <h2 class="h3 border-bottom border-2 border-dark d-inline-block fw-light">
                                                ভোটার এলাকা স্থানান্তর প্রত্যয়ন</h2>
                                        </div>
                                    </div>
                                    <!-- Row end -->
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ ভোটার এলাকা স্থানান্তর প্রত্যয়ন প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                     ...
                                     <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p>আমার</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="present_zila" value="" data-bv-notempty-message="দয়া করে নাম লিখুন" required="" data-bv-field="applicant"><i class="form-control-feedback bv-no-label" data-bv-icon-for="applicant" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="applicant" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে নাম লিখুন</small>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                        <p class="me-2">জেলার</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-100 nid-birth" type="text" name="present_upazila" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1">উপজেলায়</p>
                                            <div class="flex-fill form-group">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="present_village" value="" data-bv-notempty-message="দয়া করে পিতা/স্বামীর নাম লিখুন">
                                            </div>
                                        </div>
                                         </div>
                                          <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1">গ্রামে উল্লেখিত ঠিকানায় ভোটার তালিকায় তার নাম অন্তর্ভুক্ত আছে।বর্তমানে আমি আপনার গ্রাম:</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="transfer_village" value="" data-bv-notempty-message="দয়া করে মাতার নাম লিখুন" required="" data-bv-field="village_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="village_name" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="village_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে
                                                    মাতার নাম লিখুন</small>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex flex-fill"> 
                                            <p>ডাকঘরঃ</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="transfer_basha" value="" data-bv-notempty-message="দয়া করে  নাম লিখুন" required="" data-bv-field="village_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="village_name" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="village_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে নাম লিখুন</small>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1">উপজেলাঃ</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="transfer_upazila" value="" data-bv-notempty-message="দয়া করে ডাকঘরের নাম লিখুন" required="" data-bv-field="union_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="union_name" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="union_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে ডাকঘরের নাম লিখুন</small>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1">জেলাঃ</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="transfer_zila" value="" data-bv-notempty-message="দয়া করে ডাকঘরের নাম লিখুন" required="" data-bv-field="union_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="union_name" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="union_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে ডাকঘরের নাম লিখুন</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-block">
                                        <p>দীর্ঘদিন ধরে বসবাস করি।তাই বর্তমান ঠিকানায় তার ভোটার স্থানান্তর করতে ইচ্ছুক।</p>
                                    </div>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি ভোটার এলাকা স্থানান্তর প্রত্যয়ন প্রদানের
