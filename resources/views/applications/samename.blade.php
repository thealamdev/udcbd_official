                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ  প্রত্যায়ন পত্র নাম প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                     ...
                                     <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p>আমার জানামতে:</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="rn1" value="" data-bv-notempty-message="দয়া করে নাম লিখুন" required="" data-bv-field="applicant"><i class="form-control-feedback bv-no-label" data-bv-icon-for="applicant" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="applicant" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে নাম লিখুন</small>
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                        <p class="me-2">এবং</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-100 nid-birth" type="text" name="rn2" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <p class="me-2">এই উভয় নামে একই ব্যাক্তি</p>
                                        <div class="flex-fill form-group has-feedback">
                                            <input class="border-0 border-bottom-dotted bg-transparent w-30 nid-birth" type="hidden" name="niDHFd_birth" value="" data-bv-notempty-message="দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর লিখুন" required="" data-bv-field="nid_birth"><i class="form-control-feedback bv-no-label" data-bv-icon-for="nid_birth" style="display: none;"></i>
                                            <small class="help-block" data-bv-validator="notEmpty" data-bv-for="nid_birth" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জাতীয় পরিচয়পত্র / জন্ম সনদের নম্বর
                                                লিখুন</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি প্রত্যায়ন পত্র নাম প্রদানের
