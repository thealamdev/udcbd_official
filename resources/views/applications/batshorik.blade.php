                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center mb-4">
                                            <h2 class="h3 border-bottom border-2 border-dark d-inline-block fw-light">
                                                বাৎসরিক আয়ের সনদের আবেদনপত্র</h2>
                                        </div>
                                    </div>
                                    <!-- Row end -->
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ বাৎসরিক আয়ের সার্টিফিকেট প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                     ...
                                     <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p>আমার বার্ষিক আয় প্রায়</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="gurdian_yearly_earn" value="" data-bv-notempty-message="দয়া করে  নাম লিখুন" required="" data-bv-field="dead_person_village"><i class="form-control-feedback bv-no-label" data-bv-icon-for="dead_person_village" style="display: none;"></i>
                                        ...
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1"> টাকা</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="hidden" name="gurdian_yHTRYREYYERERYearly_earn" value="" data-bv-notempty-message="দয়া করে উপজেলার নাম লিখুন" required="" data-bv-field="dead_person_upazila"><i class="form-control-feedback bv-no-label" data-bv-icon-for="dead_person_upazila" style="display: none;"></i>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি বাৎসরিক আয়ের  সার্টিফিকেট প্রদানের
