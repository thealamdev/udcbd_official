                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ মৃত্যু সনদ প্রদানের অনুমতি প্রসঙ্গে।</p>
                                   ...
                                   <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p>মৃত্যু তারিখঃ</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="death_date" value="" data-bv-notempty-message="দয়া করে  নাম লিখুন" required="" data-bv-field="dead_person_village"><i class="form-control-feedback bv-no-label" data-bv-icon-for="dead_person_village" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="dead_person_village" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে নাম লিখুন</small>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1"> </p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="hidden" name="upazilSGDa_name" value="" data-bv-notempty-message="দয়া করে উপজেলার নাম লিখুন" required="" data-bv-field="dead_person_upazila"><i class="form-control-feedback bv-no-label" data-bv-icon-for="dead_person_upazila" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="dead_person_upazila" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে উপজেলার নাম লিখুন</small>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1"> </p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-75" type="hidden" name="zilGDSa_name" value="" data-bv-notempty-message="দয়া করে জেলার নাম লিখুন" required="" data-bv-field="dead_person_zila"><i class="form-control-feedback bv-no-label" data-bv-icon-for="dead_person_zila" style="display: none;"></i>।
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="dead_person_zila" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জেলার নাম লিখুন</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি মৃত্যু সনদ প্রদানের
