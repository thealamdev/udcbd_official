                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="row">
                                        <div class="col-12 text-center mb-4">
                                            <h2 class="h3 border-bottom border-2 border-dark d-inline-block fw-light">
                                                জাতীয়তা সনদ সনদের আবেদনপত্র</h2>
                                        </div>
                                    </div>
                                    <!-- Row end -->
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ জাতীয়তা সার্টিফিকেট প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি জাতীয়তা সনদ  প্রদানের
