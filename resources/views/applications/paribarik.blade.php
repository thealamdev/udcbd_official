                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ পারিবারিক সার্টিফিকেট প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-flex flex-fill">
                                            ...
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-75" type="text" name="union_name" value="" data-bv-notempty-message="দয়া করে জেলার নাম লিখুন" required="" data-bv-field="zila_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="zila_name" style="display: none;"></i>।
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="zila_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জেলার নাম লিখুন</small>
                                            </div>
                                            </div>
                                    </div>
                                    ...
                                    <div class="d-block text-center">
                                        <p class="fw-bold">পারিবারিক তথ্য</p>
                                    </div>
                                    <!-- Row end -->
                                    ...
                                    <!-- Row start -->
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থকলে আমি ব্যক্তিগতভাবে দ্বায়ী থাকব। অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি পারিবারিক সার্টিফিকেট প্রদানের অনুমতি দানে কৃতজ্ঞ করবেন।।</p>
                                    </div>
                                    <!-- Row end -->
