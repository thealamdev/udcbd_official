                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ অভিভাবকের অনুমতিপত্র প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-print-none d-flex flex-fill">
                                            <p class="ms-1 small">এই মর্মে আঙ্গিকার করেতিছি যে, আমার পুত্র/কন্যা</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="d-print-none border-0 border-bottom-dotted bg-transparent w-100" type="text" name="celer" value="" data-bv-notempty-message="দয়া করে ডাকঘরের নাম লিখুন" required="" data-bv-field="union_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="union_name" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="union_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে ডাকঘরের নাম লিখুন</small>
                                            </div>
                                        </div>
                                         
                                        <div class="d-flex flex-fill form-group has-feedback d-print-none">
                                            <p class="ms-1 small">সে সাহসিকতা ও মনোবলে বলিয়ান হেতু বাংলাদেশ</p>
                                            <div class="flex-fill">
                                                <input class="d-print-none border-0 border-bottom-dotted bg-transparent w-100" type="text" name="bahinir" value="" data-bv-notempty-message="দয়া করে উপজেলার নাম লিখুন" required="" data-bv-field="upazila_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="upazila_name" style="display: none;"></i>
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p class="ms-1"> বাহীনিতে যোগ দিয়া দেশ রক্ষার কাজে আত্ম নিয়োগ করার  জন্য  আমি সুস্থ মস্তিষ্কে এবং সজ্ঞানে অনুমতি প্রদান করিলাম।</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-75" type="hidden" name="zila_ntretame" value="" data-bv-notempty-message="দয়া করে জেলার নাম লিখুন" required="" data-bv-field="zila_name"><i class="form-control-feedback bv-no-label" data-bv-icon-for="zila_name" style="display: none;"></i>
                                                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="zila_name" data-bv-result="NOT_VALIDATED" style="display: none;">দয়া করে জেলার নাম লিখুন</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি অভিভাবকের অনুমতিপত্র প্রদানের
