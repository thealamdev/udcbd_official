                            ...
                            <div class="row justify-content-center">
                                <div class="col-12 col-xxl-10">
                                    ...
                                    <div class="d-block">
                                        ...
                                        <p>বিষয়ঃ মাসিক আয়ের সার্টিফিকেট প্রদানের অনুমতি প্রসঙ্গে।</p>
                                    ...
                                    <div class="d-flex">
                                     ...
                                     <div class="d-flex">
                                        <div class="d-flex flex-fill">
                                            <p>আমার মাসিক আয় প্রায়</p>
                                            <div class="flex-fill form-group has-feedback">
                                                <input class="border-0 border-bottom-dotted bg-transparent w-100" type="text" name="gurdian_monthly_earn" value="" data-bv-notempty-message="দয়া করে  নাম লিখুন" required="" data-bv-field="dead_person_village"><i class="form-control-feedback bv-no-label" data-bv-icon-for="dead_person_village" style="display: none;"></i>
                                    ...
                                    <div class="d-block">
                                        <p>আমার জানামতে উপরোক্ত তথ্য সত্য ও সঠিক। কোন প্রকার ভুল বা গড়মিল থাকলে আমি
                                            ...
                                            অতএব, উপরোক্ত তথ্যাবলী যাচাই পূর্বক আমাকে একটি মাসিক আয়ের  সার্টিফিকেট প্রদানের
