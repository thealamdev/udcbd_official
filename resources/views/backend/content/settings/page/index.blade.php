            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.setting.page.store') }}"
                        ...
                        <div class="form-group">
                            <label>Page Description-1</label>
                            <textarea id="" class="editor form-control" col="10" row="3" name="description"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Page Description-2</label>
                            <textarea id="" class="editor2 form-control" col="10" row="3" name="description2"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Page Description-3</label>
                            <textarea id="" class="editor3 form-control" col="10" row="3" name="description3"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Page Description-4</label>
                            <textarea id="" class="editor4 form-control" col="10" row="3" name="description4"></textarea>
                        </div>
                        <div class="form-group">
