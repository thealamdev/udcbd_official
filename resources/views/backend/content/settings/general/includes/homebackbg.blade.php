    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        {{ html()->label('Result Section Background Image')->for('volunteer_bg_image') }}
                        ...
                        <div class="d-block">
                            <label for="volunteer_bg_image">
                                <img src="{{ asset(get_setting('volunteer_bg_image', $demoImg)) }}" class="border img-fluid rounded holder" alt="Image upload">
                            </label>
                        </div>
                    </div> <!-- form-group-->
                </div>
