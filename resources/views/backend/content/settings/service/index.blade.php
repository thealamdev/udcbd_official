                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('admin.setting.service.store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" rows="3" name="service_details[]" id="service_details"
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($multis as $multi)
                            <tr>
                                <td><img src="{{ asset('/setting/banner/' . $multi->service_image) }}"
                                ...
                                <td>
                                    <a href="/admin/setting/service/edit/{{ $multi->id }}"
