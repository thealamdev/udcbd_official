                ...
                <div class="card-body">
                    <form action="{{ route('admin.setting.service.update') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="header_title" value="{{ $notice->header_title }}"
                                class="form-control">
                            <input type="hidden" name="notice_id" value="{{ $notice->id }}" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Bottom Service</label>
                            <input type="text" name="bottom_title" value="{{ $notice->bottom_title }}"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Details</label>
                            <textarea type="text" rows="5" name="details" value="{{ $notice->details }}" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Galary</label>
