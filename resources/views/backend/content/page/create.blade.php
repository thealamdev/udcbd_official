        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title">Page Management <small class="ml-2">Create page</small></h3>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        <input type="text" name="post_title" value="{{ old('post_title') }}" class="form-control cash"
                    ...
                    <div class="form-group">
                        <textarea name="post_excerpt" class="form-control" rows="2" id="post_excerpt" placeholder="Excerpt">{{ old('post_excerpt') }}</textarea>
                        @error('post_excerpt')
                            <p class="text-danger margin-bottom-none">{{ $message }}</p>
                        @enderror
                    </div> <!-- form-group -->
            ...
            <div class="card">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input type="radio" class="form-check-input" name="thumb_status" value="0"
                                id="off" class="checking">
