...
<div class="row">
              ...
              <div class="row" style="margin-top:-8rem;">
                  ...
                  <div class="col-8 text-center">
                      ...
                      <h4 class="language-switch" data-en="{{ $application->noe }} No. {{ $application->une }} Union Parishad" data-bn="{{ $application->applied_union_no }} নং {{ $union->bn_name }} ইউনিয়ন পরিষদ" style="color:#7030A0;font-size:30px;">{{ $application->applied_union_no }} নং {{ $union->bn_name }}
                          ইউনিয়ন পরিষদ</h4>
                      <h6 class="language-switch" style="font-size:20px" data-en="Chairman Name: {{$application->che }}, " data-bn="চেয়ারম্যানের নাম: {{ $application->applied_chairman_name}}, " style="color:#000000;">চেয়ারম্যানে: {{ $application->applied_chairman_name }},
                  </div>
                  <div class="col-2 text-center mt-3">
              ...
              <div class="row mt-3 mb-5" style="margin-top: 2rem;">
                  ...
                  <div class="col-6 text-center border border-2 rounded-pill border-dark"
                      ...
                      <h6 style="font-size:25px;" class="m-2 language-switch" data-en="Permanent Resident Certificate" data-bn="স্থায়ী বাসিন্দা সনদ">স্থায়ী বাসিন্দা সনদ</h6>
                  </div>
        ...
        <p style="font-size: 18.8px;letter-spacing: 1px;margin-top: 2rem; text-align:justify;" id="text" class="language-switch default-line-spacing" data-en="In this sense, the certificate of Permanent Resident is being issued, <strong>{{ $application->applicant }}</strong> National Identity Card / Birth Certificate No:  <strong>{{ $application->nid_birth }}</strong> Father/Husband:  <strong>{{ $application->father_husband_name }}, </strong>Village: <strong>{{ $application->mrgram }},</strong> Ward:   <strong>{{ $application->mrword }}</strong>, Post office: <strong>{{ $application->mrdak }}, </strong>
           ...
           এই মর্মে স্থায়ী বাসিন্দা সনদ প্রদান করা যাইতেছে যে, <strong>{{ $application->applicant }}</strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং: <strong>{{ $application->nid_birth }}</strong> পিতা/স্বামীঃ <strong>{{ $application->father_husband_name }}, </strong>গ্রামঃ<strong>{{ $application->mrgram }},</strong> ওয়ার্ডঃ <strong>{{ $application->mrword }}</strong>, ডাকঘরঃ<strong>{{ $application->mrdak }}, </strong>
