...
<div id="content">
    <div class="container-fluid card print-card shadow print-shadow-0 print-m-0 certificate-form font-15 d-print-block">
        <div class="card-body print-p-0">
            <div class="col-12 col-lg-10 col-xxl-8 pt-3 p-5 certificate-style marl">
                ...
                <div class="row" style="margin-top:-8rem;">
                    ...
                    <div class="col-8 text-center">
                        <h6 class="language-switch" data-en="Bismillahir Rahmanir Rahim"
                            data-bn="বিসমিল্লাহির রাহমানির রাহিম" style="color:#8E5BB4;"> বিসমিল্লাহির রাহমানির রাহিম
                        </h6>
                        <h6 class="language-switch" data-en="Government of the People's Republic of Bangladesh"
                            data-bn="গণপ্রজাতন্ত্রী বাংলাদেশ সরকার" style="color:#8E5BB4; font-size:20px;">
                            গণপ্রজাতন্ত্রী বাংলাদেশ সরকার</h6>
                        <h4 class="language-switch"
                            data-en="{{ $application->noe }} No. {{ $application->une }} Union Parishad"
                            data-bn="{{ $application->applied_union_no }} নং {{ $union->bn_name }} ইউনিয়ন পরিষদ"
                            style="color:#7030A0;font-size:30px;">{{ $application->applied_union_no }} নং
                            {{ $union->bn_name }}
                            ইউনিয়ন পরিষদ</h4>
                        <h6 class="language-switch" style="font-size:20px"
                            data-en="Chairman Name: {{ $application->che }}, "
                            data-bn="চেয়ারম্যানের নাম: {{ $application->applied_chairman_name }}, "
                            style="color:#000000;">চেয়ারম্যান: {{ $application->applied_chairman_name }},
                    </div>
                    <div class="col-2 text-center mt-3">
                ...
                <div class="row">
                    ...
                    <div class="col-8 text-center">
                        <h6 class="language-switch" style="color:#000000; font-size:20px;"
                            data-en=" Upazilla: {{ $application->upe }}, District :{{ $application->eng }}। "
                            data-bn="উপজেলা : {{ $application->applied_upazilla_name }}, জেলা : {{ $application->applied_zilla_name }}। ">
                            উপজেলা : {{ $application->applied_upazilla_name }}, জেলা :
                ...
                <div class="row mt-3 mb-5" style="margin-top: 2rem;">
                    <div style="font-size:18.8px" class="col-3 my-auto language-switch"
                        data-en="Memo No. - {{ $application->form_serial }}"
                        data-bn="স্মারক নং - {{ $application->form_serial }}">স্মারক নং -
                        {{ $application->form_serial }}</div>

                    <div class="col-6 text-center border border-2 rounded-pill border-dark"
                        style="background-color: #B4D5FF;margin-top:6em;">
                        <h6 style="font-size:25px;" class="m-2 language-switch" data-en="Certificate"
                            data-bn="প্রত্যয়ন পত্র">প্রত্যয়ন পত্র</h6>
                    </div>

                    <div style="font-size:18.8px" class="col-3 text-right my-auto language-switch"
                        data-en="Date: {{ $application->date }}" data-bn="তারিখঃ {{ $application->date }}">তারিখঃ
           ...
           নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও জানি। সে সমাজ বা রাষ্ট্র বিরোধী কোন প্রকার কাজের সহিত জড়িত নাই। সে বাংলাদেশের স্থায়ী নাগরিক ও বাসিন্দা। আমার জানা মতে তিনি আর্থিক ভাবে অস্বচ্ছল.">
                    এই মর্মে আর্থিক অস্বচ্ছলতার সনদ প্রদান করা যাইতেছে যে,
                    <strong>{{ $application->applicant }}</strong> জাতীয় পরিচয়পত্র / জন্ম সনদ নং:
                    <strong>{{ $application->nid_birth }}</strong> পিতা/স্বামীঃ
                    <strong>{{ $application->father_husband_name }},
                    </strong>গ্রামঃ<strong>{{ $application->mrgram }},</strong> ওয়ার্ডঃ
                    <strong>{{ $application->mrword }}</strong>, ডাকঘরঃ<strong>{{ $application->mrdak }}, </strong>
                    </strong>ইউনিয়নঃ <strong>{{ $application->union_name }}</strong>, উপজেলাঃ
                    <strong>{{ $application->upazilla_name }}</strong>, জেলাঃ
                    <strong>{{ $application->zilla_name }}</strong> তিনি আমার ইউনিয়নের
                    <strong>{{ $application->mrword }}</strong>
                    নং ওয়ার্ডের একজন স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও জানি। সে সমাজ বা রাষ্ট্র বিরোধী
                    কোন প্রকার কাজের সহিত জড়িত নাই। সে বাংলাদেশের স্থায়ী নাগরিক ও বাসিন্দা।আমার জানা মতে তিনি আর্থিক
                    ভাবে অস্বচ্ছল.


                </p>
                <p style="font-size: 18.8px;letter-spacing: 1px;" id="text"
                    class="language-switch default-line-spacing" class="language-switch"
                    data-en="I pray for the forgiveness/peace of his soul."
                    data-bn="
                ...
                <div class="row mb-4 print-mb-2" style="margin-top: 6em;">
                    ...
                    <div class="col-3 d-flex align-items-center">
                        <div class="text-center border border-1 seal-border">
                            <p class="mt-3 pt-4 font-6 language-switch" data-en="Seal of office"
                                data-bn="কার্যালয়ের সীল"> কার্যালয়ের সীল </p>
                        </div>
                    </div>
                    ...
                    <div class="col-3 text-cnenter justify-content-center align-items-center mt-4">
                        ...
                        <p class="font-6 language-switch" data-en="Manufacturer's seal and signature"
                            data-bn="প্রস্তুত কারীর সীল ও স্বাক্ষর">প্রস্তুত কারীর সীল ও স্বাক্ষর</p>
                    </div>
                    <div class="col-3 text-center justify-content-center align-items-center mt-4">
                        <hr style="border: 1px solid black; width:90%">
                        <p class="font-6 language-switch" data-en="Seal and signature of UP member"
                            data-bn="ইউপি সদস্যর সীল ও স্বাক্ষর">ইউপি সদস্যর সীল ও স্বাক্ষর</p>
                    </div>
                    <div class="col-3 text-center justify-content-center align-items-center mt-4">
                        <hr style="border: 1px solid black; width:90%">
                        <p class="font-6 language-switch" data-en="of the approver
Seal and Signature"
                            data-bn="অনুমোদন কারীর
                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        <p class="language-switch"
                            data-en="Scan the certificate with the QR CODE app on your mobile to verify it"
                            data-bn="সনদটি যাচাই করতে আপনার মোবাইলে থাকা QR CODE অ্যাপ দিয়ে স্ক্যান করুন"
                            style="margin-left: 3rem; margin-top: 4rem;margin-bottom: -3rem;">সনদটি যাচাই করতে আপনার
                            মোবাইলে থাকা QR CODE অ্যাপ দিয়ে স্ক্যান করুন </p>
                    </div>
                </div>
                <!--form body end here -->
            </div>
